"""
Bluetooth Special Intereste Group Company Identifiers

This DICT is used to resolve company identifiers (in bytes) to the company names.
As of Feb 2020, the ofificial list is published on the Bluetooth SIG Site
https://www.bluetooth.com/specifications/assigned-numbers/company-identifiers/

When new coampanies are added (are they ever removed?) please add them to the
file at the end and in the format as specified. Use the Company name as specified
by the Bluetooth SIG. Only exception is our use of double-quotes in the dictionary
and single-qoutes in company names.
"""
